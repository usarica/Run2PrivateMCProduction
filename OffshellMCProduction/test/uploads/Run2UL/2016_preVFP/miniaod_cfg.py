...
# with command line options: --python_filename miniaod_cfg.py --eventcontent MINIAODSIM --datatier MINIAODSIM --filein file:aod.root --fileout file:miniaod.root --customise Configuration/DataProcessing/Utils.addMonitoring --conditions 106X_mcRun2_asymptotic_preVFP_v11 --step PAT --procModifiers run2_miniAOD_UL --geometry DB:Extended --era Run2_2016_HIPM --runUnscheduled --no_exec --mc -n -1
