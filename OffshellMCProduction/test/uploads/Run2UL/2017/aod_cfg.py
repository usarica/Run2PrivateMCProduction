...
# with command line options: --python_filename aod_cfg.py --eventcontent AODSIM --datatier AODSIM --filein file:hlt.root --fileout file:aod.root --customise Configuration/DataProcessing/Utils.addMonitoring --conditions 106X_mc2017_realistic_v6 --step RAW2DIGI,L1Reco,RECO,RECOSIM --geometry DB:Extended --era Run2_2017 --runUnscheduled --no_exec --mc -n -1
